...
class TowerTest {
    ...
    void moveAllSides(){
        ...
        board.movePiece(new Position(0, 6), new Position(0,5), null);
        board.movePiece(new Position(0, 0), new Position(0,2), null);
        board.movePiece(new Position(6, 6), new Position(6,5), null);
        board.movePiece(new Position(0, 2), new Position(3,2), null);
        board.movePiece(new Position(3, 6), new Position(3,4), null);
        board.movePiece(new Position(3, 2), new Position(3,4), null);
        board.movePiece(new Position(0, 5), new Position(0,4), null);
        var valid = board.getValidPlaces(new Position(3, 4), null, null);
