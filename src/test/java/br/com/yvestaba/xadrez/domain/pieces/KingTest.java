...
class KingTest {
    ...
    void moveFront(){
        ...
        var valid = board.getValidPlaces(new Position(4,0), null, null);
    ...
    void moveBack(){
        board.movePiece(new Position(4,1), new Position(4,3), null);
        board.movePiece(new Position(4,6), new Position(4,4), null);
        board.movePiece(new Position(4,0), new Position(4,1), null);
        board.movePiece(new Position(3,6), new Position(3,5), null);

        var valid = board.getValidPlaces(new Position(4,1), null, null);
    ...
    @Test
    void moveSW(){
        board.movePiece(new Position(5,1), new Position(5,3), null);
        board.movePiece(new Position(4,6), new Position(4,4), null);
        board.movePiece(new Position(4,0), new Position(5,1), null);
        board.movePiece(new Position(3,6), new Position(3,5), null);
        var valid = board.getValidPlaces(new Position(5,1), null, null);
    ...
    void moveNW(){
        ...
        board.movePiece(new Position(4,6), new Position(4,4), null);
        board.movePiece(new Position(4,0), new Position(3,1), null);
        board.movePiece(new Position(3,6), new Position(3,5), null);
        var valid = board.getValidPlaces(new Position(3,1), null, null);
        assertTrue(valid.contains(new Position(4,0)));
