...
class KingTest {
    ...
    void moveFront(){
        ...
        var valid = board.validMoves(new Position(4,0));
    ...
    void moveBack(){
        ...
        var valid = board.validMoves(new Position(4,1));
    ...
    void moveSW(){
        ...
        board.movePiece(new Position(3,6), new Position(3,5));
        var valid = board.validMoves(new Position(5,1));
    ...
    void moveNW(){
        ...
        board.movePiece(new Position(3,6), new Position(3,5));
        var valid = board.validMoves(new Position(3,1));
        assertTrue(valid.contains(new Position(4,0)));
